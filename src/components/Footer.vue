    ...
    <div class="max-w-7xl mx-auto px-6 py-12">
      ...
      <div class="mt-12 pt-8 border-t border-gray-200 flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-4">
        ...
        <div class="flex justify-center gap-4">
          <!-- Twitter -->
          <a href="#" class="text-gray-500 hover:text-indigo-500 transition-colors" aria-label="Twitter">
          ...
          <!-- GitHub -->
          <a href="#" class="text-gray-500 hover:text-indigo-500 transition-colors" aria-label="GitHub">
            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
